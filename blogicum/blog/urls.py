...
urlpatterns = [
    ...
    path('profile/edit/', views.edit_profile, name='edit_profile'),  # Этот должен быть ПЕРВЫМ
    path('profile/<str:username>/', views.profile, name='profile'),  # Этот должен быть ПОСЛЕ
    ...
    path('auth/logout/', LogoutView.as_view(template_name='registration/logged_out.html'), name='logout'),
